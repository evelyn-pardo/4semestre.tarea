  ...
  d.addEventListener("click", (e) => {
    if (e.target.matches(btnMostrar)) {
      ...
      interval = setInterval(() => {
        ...
        let restaFechas =
          (fechaUsuario.getTime() - fechaActual.getTime() + 1000) / 1000;
        ...
        let restaHoras = ("0" + Math.floor((restaFechas / 3600) % 24)).slice(
          -2
        );
        let restaMinutos = ("0" + Math.floor((restaFechas / 60) % 60)).slice(
          -2
        );
